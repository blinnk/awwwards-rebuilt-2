...
import { HomeAboutSection, About, Services, AccordionIcon, AccordionHeader, AccordionContent } from "../../styles/homeStyles";
  ...
  return (
    ...
    >
      <Container>
        <Flex alignTop>
          <About>
            <h2>Furrow is an integrated, full-service creative studio offering video production, creative development, and post-production services.
            </h2>
            <p>
